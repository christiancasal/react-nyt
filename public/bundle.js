...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helper = __webpack_require__(231);
	  ...
	  _createClass(Search, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'button',
	                  { type: 'button', className: 'btn btn-danger btn-sm', onClick: this.formHandler.bind(this) },
	                  _react2.default.createElement(
	                    'h4',
	                    null,
	                    'Submit'
	        ...
	        ' ',
	        _react2.default.createElement(_results2.default, { data: this.state.data })
	    ...
	    value: function formHandler() {
	      ...
	      var response = _helper2.default.performApiCall(formValues.search, formValues.start, formValues.end);
	      console.log(response);

	      this.setState({
	        data: [formValues.search, formValues.start, formValues.end]
	      });
	    }
	  }]);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h5',
	          { className: 'col-md-12' },
	          'This will be the title/url'
	        ),
	        _react2.default.createElement(
	          'h6',
	          { className: 'col-md-8' },
	          'This will be the date published'
	        ),
	        _react2.default.createElement(
	          'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helper = {
	  performApiCall: function performApiCall(term, startYear, endYear) {
